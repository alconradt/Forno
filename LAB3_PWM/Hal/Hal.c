...
#include <Z:\AAM_EXP3\LAB3_PWM\Header\Hal_prm.h>
#include <Z:\AAM_EXP3\LAB3_PWM\Header\SevenSeg.h>
//-------------------------------------- PUBLIC (Variables) -----------------------------------------------------------
...
unsigned char Hal_Leds_Buffer[NUM_OF_LEDS];   // não chama direto o Gpio, mas escreve nesta variável
