...
typedef struct
{
   ...
   // Completar o endereço!!!    **************// FEITO
// Port Data and Direction Registers Address
#define ADC_ADCL  (*((volatile ADC_REG_TYPE *)0x00000078))	/*** ADCL  - Data Result Low  Register;     ***/
#define ADC_ADCH  (*((volatile ADC_REG_TYPE *)0x00000079))   /*** ADCH  - Data Result High Register;     ***/
#define ADC_ADCSRA   (*((volatile ADC_REG_TYPE *)0X0000007A))    /*** ADCRH  - Data Result High Register;      ***/
#define ADC_ADCSRB   (*((volatile ADC_REG_TYPE *)0x0000007B))    /*** ADCRL  - Data Result Low Register;       ***/
#define ADC_ADMUX  (*((volatile ADC_REG_TYPE *)0x0000007C))    /*** ADCCVH - Compare Value High Register;    ***/
#define ADC_DIDR0  (*((volatile ADC_REG_TYPE *)0x0000007E))    /*** ADCCVL - Compare Value Low Register;     ***/
#define ADC_DIDR1  (*((volatile ADC_REG_TYPE *)0x0000007F))    /*** ADCCFG - Configuration Register;         ***/
